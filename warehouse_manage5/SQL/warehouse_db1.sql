...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 07, 2025 lúc 05:57 PM
...
(2, 'Bùi Văn G', '09333444556', 'USER1', 'Nhân viên'),
...
(7, 2, '2025-04-07', 2, 'pending'),
(8, 4, '2025-04-07', 2, 'pending'),
(9, 1, '2025-04-07', 2, 'confirmed'),
(10, 3, '2025-04-07', 7, 'pending'),
(11, 1, '2025-04-07', 7, 'pending'),
(12, 3, '2025-04-07', 7, 'pending');
...
('show', 1, 'Áo thun', 'Thời trang', 'M', 'đen', 100000, 160000, 20, '2025-03-01'),
('show', 2, 'Quần jeans', 'Thời trang', 'L', 'Xanh', 200000, 300000, 30, '2025-03-02'),
('show', 3, 'Giày thể thao', 'Giày dép', '42', 'Đen', 500000, 700000, 9, '2025-03-03'),
('show', 4, 'Balo du lịch', 'Phụ kiện', 'One-size', 'Xám', 250000, 350000, 30, '2025-03-04'),
...
('show', 10, 'Ao Lot', 'Ao Nu', 'C', 'trắng', 100000, 150000, 100, '2025-03-21'),
('show', 11, 'áo sơ mi', 'áo nam', 'M', 'trắng', 200000, 250000, 0, '2025-04-05'),
('show', 12, 'hoodie', 'áo nam', 'XL', 'đen', 200000, 150000, 230, '2025-04-05'),
('show', 13, 'Áo Quây', 'Áo Nữ', 'S', 'Đen', 100000, 200000, 0, '2025-04-07'),
('show', 14, 'Tất', 'Phụ Kiện', 'FreeSize', 'Đen', 10000, 150000, 0, '2025-04-07'),
('show', 15, 'Mũ Len', 'Mũ', 'FreeSize', 'Đỏ', 1, 200000, 0, '2025-04-07'),
('show', 16, 'Mũ Lưỡi Trai', 'Mũ', 'FreeSize', 'Xanh', 100, 150000, 0, '2025-04-07');
...
('USER1', 'user1', '$2y$10$vR65OLOKPTdr10GExAfYkuuCcl.fU0xIvwF.z0ryCQ0Mahphc1d4W', 'Nhân viên', 'normal'),
...
('USER6', 'ch1', '$2y$10$NYtekwqIDyI3n7bY0kEhcOfsG7Hcf8djFFywwl491oW4Nco81lFRG', 'Cửa Hàng', 'normal'),
...
(4, '2025-03-13', 3, 'pending', 'CH001'),
(5, '2025-04-07', 2, 'pending', 'CH001'),
(6, '2025-04-07', 2, 'deny', 'CH001'),
(7, '2025-04-07', NULL, 'pending', 'CH001');
